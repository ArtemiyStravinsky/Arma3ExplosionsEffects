...
IED_SMOKE_LARGE = {
    ...
    0 = [_loc, _aslLoc] spawn {
        ...
        for "_i" from 0 to _numPlumes - 1 do {
            ...
            switch (_r) do {
                case 0: {
                    [_loc, _aslLoc, 500, 200] spawn SAND_TRAIL_SMOKE;
                };
                case 1: {
                    [_loc, _aslLoc, 500, 200] spawn GRAY_TRAIL_SMOKE;
                };
                case 2: {
                    [_loc, _aslLoc, 500, 200] spawn BROWN_TRAIL_SMOKE;
                };
            };
        };
    };
    ...
    0 = _aslLoc spawn {
        ...
        _smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0, 0, 0, 1], [0.35, 0.35, 0.35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke1 setDropInterval 0.005;
        ...
        _smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.78, 0.76, 0.71, 1], [0.35, 0.35, 0.35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        ...
        _smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.55, 0.47, 0.37, 1], [0.35, 0.35, 0.35, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke3 setDropInterval 0.005;
        ...
        _smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 6, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.1, 0.1, 0.1, 1], [0.2, 0.2, 0.2, 0.35], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke4 setDropInterval 0.005;
        ...
        _smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 14, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke1 setDropInterval 0.005;

        _smoke2 setParticleRandom [0, [3 + random 4, 3 + random 4, 5], [8 + random 5, 8 + random 5, 5], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 14, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke2 setDropInterval 0.005;

        _smoke3 setParticleRandom [0, [3 + random 4, 3 + random 4, 5], [8 + random 5, 8 + random 5, 5], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 14, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke3 setDropInterval 0.005;

        _smoke4 setParticleRandom [0, [3 + random 4, 3 + random 4, 5], [8 + random 5, 8 + random 5, 5], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 14, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke4 setDropInterval 0.005;

        sleep 1;

        _smoke1 setParticleRandom [0, [5 + random 5, 5 + random 5, 5], [2 + random 5, 2 + random 5, 1], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke1 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 25, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke1 setDropInterval 0.005;

        _smoke2 setParticleRandom [0, [5 + random 5, 5 + random 5, 5], [2 + random 5, 2 + random 5, 1], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke2 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 25, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke2 setDropInterval 0.005;

        _smoke3 setParticleRandom [0, [5 + random 5, 5 + random 5, 5], [2 + random 5, 2 + random 5, 1], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke3 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 25, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke3 setDropInterval 0.005;

        _smoke4 setParticleRandom [0, [5 + random 5, 5 + random 5, 5], [2 + random 5, 2 + random 5, 1], 0, 0.25, [0.05, 0.05, 0.05, 0.1], 0, 0];
        _smoke4 setParticleParams [["\A3\data_f\cl_fireD", 1, 0, 1], "", "Billboard", 1, 25, [0, 0, 0], [0, 0, 0], 0, 10, 7.85, 0.375, [6 + random 4, 10 + random 4, 14 + random 4], [[0.35, 0.35, 0.35, 1], [0.2, 0.2, 0.2, 0.5], [0.35, 0.35, 0.35, 0]], [0.08], 1, 0, "", "", _aslLoc];
        _smoke4 setDropInterval 0.005;
